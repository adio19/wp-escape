...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_deregister_script('jquery');
				wp_register_script('jquery-one', ASSETS_URL . 'assets/scripts/jquery-3.1.1.min.js', false, '3.1.1', true);
				wp_register_script('jquery-two', ASSETS_URL . 'assets/scripts/custom.min.js', false, 'false', true);

        wp_register_script('js_main', ASSETS_URL . '/assets/scripts/custom.js', array('jquery-one', 'jquery-two'), '1.0', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		wp_register_style('bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', array(), false, 'all');
		wp_register_style('bootstrap-two', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css', array(), false, 'all');
		wp_register_style('main-css', ASSETS_URL . '/assets/css/styles.css', array('bootstrap', 'bootstrap-two'), false, 'all');
